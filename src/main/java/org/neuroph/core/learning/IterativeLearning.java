...
abstract public class IterativeLearning extends LearningRule implements
    ...
    final public void learn(DataSet trainingSet) {
        ...
        while (!isStopped()) {
            ...
            fireLearningEvent(new InfoLearningEvent(this, LearningEventType.EPOCH_ENDED));
        ...
        onStop();
        fireLearningEvent(new InfoLearningEvent(this, LearningEventType.LEARNING_STOPPED));
    }
