...
public class Layer implements Serializable {
    ...
    public void calculate() {
    	...
    	printLayer();
    	//MyLog.write("Layer calculate", null);
...
//                    }                    
    ...
    private void printLayer() {
    	return;
//    	Neuron[] aNeurons = neurons.asArray();
//    	System.out.println("There are " + aNeurons.length + " in this layer");
//    	for (int i = 0; i < aNeurons.length; i++) {
//    		Neuron neuron = aNeurons[i];
//    		Connection[] conn = neuron.getInputConnections();
//    		if (conn == null) {
//    			System.out.println("  Neuron " + i + " has no input connection");
//    			continue;
//    		}
//    		System.out.print("  Neuron " + i + " has " + conn.length + " connections: ");
//    		for (int j = 0; j < conn.length; j++) {
//    			System.out.print(conn[i].getWeight() + " ");
//    		}
//    		System.out.println();
//    	}
    }
